...
public class InMemoryCatalog implements Catalog {
     ...
     *
     * Enum types can be compared to eachother w the ==
     *
     * Wrapper Classes (Integer, Double, Long, Boolean) cannot be compared with ==, they need to be compared with the .equals() method
     */
    @Override
