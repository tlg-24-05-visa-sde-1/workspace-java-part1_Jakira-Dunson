...
class DerivedDateTimeTest {
    ...
    public static void testPresidentsFirst100Days() {
        LocalDate inaugurationDate = LocalDate.of(2017, Month.JANUARY, 20);
        LocalDate oneHundoDay = inaugurationDate.plusDays(100);

        System.out.println(oneHundoDay);
    }
    ...
    public static void testPopularBirthdays() {
        ...
        LocalDate vDay = LocalDate.of(2023, Month.FEBRUARY, 14);
    ...
    public static void testEarlyRetirement() {
        LocalDate bday = LocalDate.of(1996, Month.AUGUST, 27);
    ...
    public static void testLaborDay() {
        LocalDate sept1 = LocalDate.of(1996, Month.AUGUST, 27);
        LocalDate laborDay = sept1.with(nextOrSame(MONDAY)); //this can be written this way do to the import above  
        //LocalDate laborDay = sept1.with(TemporalAdjusters.nextOrSame(DayOfWeek.MONDAY));  //this will show the monday it lands on, or the next monday the date lands on
    ...
    public static void testElectionDay() {
        LocalDate electionMonth = LocalDate.of(2024, Month.NOVEMBER, 1);
        LocalDate electionDay = electionMonth.with(TemporalAdjusters.nextOrSame(DayOfWeek.MONDAY)).plusDays(1);
    ...
    public static void testAnniversary() {
        LocalDate wedding = LocalDate.of(1969, Month.JUNE, 6);
